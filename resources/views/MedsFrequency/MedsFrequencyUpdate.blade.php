            ...
            <div class="row" style="width: 99%">
                <div class="col-md-12">
                    ...
                    <div class="modal-header">
                         <h1 style="font-family: 'Source Sans Pro',sans-serif; font-size:24px; color:Black; width:100%;margin-left: 30%">MEDS Update Details</h1>
                        
                        </div>
                        
           <div class="modal-body">
          <form action="{{url('MedFreqUpdate')}}" method="POST"> 
          @csrf
