...
<div ><!---unnecessary div--->
            <div class="row" style="width: 99%">
                <div class="col-md-12">
                    ...
                    <div class="modal-header">
                         <h1 style="font-family: 'Source Sans Pro',sans-serif; font-size:24px; color:Black; width:100%;margin-left: 30%">Update ItemType Details</h1>
          ...
          <div class="col-sm-8" style="margin-left: 100px"> 
           ...
           <div class="form-group" >
            <b>Item Type</b> 
            <input type="text" class="form-control" name="type" value="{{$data->ItemType}}" required> 
          </div> 
          <div class="form-group" >
           <b>Item Description</b> 
           <input type="text" class="form-control" name="desc" value="{{$data->ItemDescription}}" required> 
         </div> 
