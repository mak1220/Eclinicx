...
<div class="content-header">
    ...
    <div ><!---unnecessary div--->
      ...
      <form action="{{url('ListUpdate')}}" method="POST">  
            @csrf
          ...
          <input type="hidden" name="id" value="{{$data->id}}"  required> 
             ...
             <input type="text" class="form-control" name="mrn" value="MRN-{{$data->id}}"  style="background-color:#eeeeee"> 
            </div>  
             <div class="form-group"> 
              <label for="email">MRN-X</label> 
              <input type="text" class="form-control" name="mrnx" value="{{$data->MRNX}}" >
             </div> 
            <div class="form-group">
             <label >Patient Name</label>
              <input type="text" class="form-control"name="name" value="{{$data->Name}}" style="background-color:#ffcccb"> 
            </div>  
           ...
           <label style=" font-family: 'Source Sans Pro',sans-serif;" >Patient Age</label>
             <input type="text" class="form-control" name="age" value="{{$data->Age}}" style="background-color:#ffcccb"> 
             </div>
            ...
            <div class="form-group"> 
             ...
             <select name="disc" class="browser-default custom-select">
              <option name="disc" value="{{$data->Discount}}">{{$data->Discount}}</option>                                
              ...
              <label style=" font-family: 'Source Sans Pro',sans-serif;" >    
                 ...
                 <input type="number" name="cash" class="form-control" value="{{$data->DiscountCash}}" >
                 </div>
                   ...
                   <div class="form-group"> 
                    ...
                    <div class="form-group">
                     <label style=" font-family: 'Source Sans Pro',sans-serif;" >Remarks:</label>
                      <div class="form-group"> <textarea class="form-control"  placeholder="Enter your remarks" rows="5"></textarea></div>
               </div>
           ...
           <div class="col-sm-12">
               ...
               <div class="col-sm-12">
                <button class="btn btn-warning" type="submit" style="width: 50%;height:35px;margin-bottom: 5px;margin-left: 55%;margin-top: 2%">Update</button>
               </div>
