...
@section('encounter')
    ...
    <div ><!---unnecessary div--->
          ...
          <form action="{{url('imgUpdate')}}" method="POST"  enctype="multipart/form-data"> 
          @csrf  
  ...
  <div class="form-group row">
    <label for="end" class="col-sm-4 col-form-label">Report Doctor</label>
          <select name="doctor" id="host" style="width: 65%;margin-left: 1%">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
       <input type="text" class="form-control datepicker2" name="date" placeholder="Report Date" value="{{$itemm->date}}">
    </div>
  </div>
  <div class="form-group row">
