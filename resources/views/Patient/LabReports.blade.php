...
@section('encounter')
    ...
    <div ><!---unnecessary div--->
          ...
          <form action="{{url('LabRep')}}" method="POST" enctype="multipart/form-data"> 
          @csrf  
          @foreach($data as $item)
      @endforeach
            <div class="form-group row">
   
      <input type="hidden"  name="patient" value="{{$item->id}}" required>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-8">
       <input type="text" class="form-control datepicker2" placeholder="Report Date" name="date">
    </div>
  </div>
  <div class="form-group row">
    <label for="color" class="col-sm-4 col-form-label">Origin Date</label>
    <div class="col-sm-8">
      <input type="text" class="form-control datepicker2" placeholder="Origin Date" name="origin">
    </div>
  </div>
  <div class="form-group row">
            ...
            <div class="card">
              ...
              <div class="card-body table-responsive p-0">
                <table class="table table-hover text-nowrap" id="datatable">
                  ...
                  <tbody>
                    @foreach(App\LabReport::all() as $item)
                    <tr>
                      ...
                      <td style="text-align: center;"><a href="{{url('Reportupdate')}}/{{$item->id}}" class="btn btn-success"><i class=" fas fa-pencil-alt"></i> </a>
                      <a href="{{url('ReportDelete')}}/{{$item->id}}" onclick="return checkdelete()" class="btn btn-danger"><i class="fas fa-trash-alt" ></i></a>
                       </td>
                    </tr>
